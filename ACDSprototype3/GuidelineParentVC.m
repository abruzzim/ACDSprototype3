...
- (void)viewDidLoad {
    ...
    [self.flowchartVC.image setImage:[UIImage imageNamed:self.guidelineDict[@"pngFile"]]];
    //
    ...
    //
    NSURL *localURL = [mainBundle URLForResource:self.guidelineDict[@"htmlFile"] withExtension:@"html"];
    //
...
- (void)toggleOutlineView {
    ...
    if (self.isOutlineVisible) {
        ...
        [UIView animateWithDuration:0.3f animations:^{
            ...
            self.outlineVC.view.hidden = newHidden;
        }];
    } else {
